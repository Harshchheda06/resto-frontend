    ...
    <div className="p-2 md:p-4">
      ...
      <div className="">
        ...
        <div className="w-full">
           <h2 className="font-bold text-4xl text-slate-900 mb-6 mt-9 text-center">
             Our Speciality
           </h2>
        </div>
        ...
        <div
          className="flex gap-5 overflow-scroll items-center justify-center scrollbar-none scroll-smooth transition-all"
          ref={slideProductRef}
        >
          {speciality[0]
            ? speciality.map((el) => {
